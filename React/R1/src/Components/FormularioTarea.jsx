...
/**
 * Subcomponente atómico: formulario para agregar una nueva tarea.
 * Contiene input controlado + botón submit.
 *
 * @param {Object} props
 * @param {Function} props.onAgregar - Callback (textoTarea) => void al enviar el formulario
 */
