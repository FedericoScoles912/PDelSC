...
/**
 * Subcomponente atómico: tarjeta individual de presentación.
 * Renderiza una card con foto circular, nombre, apellido, profesión y efecto hover.
 *
 * @param {Object} props
 * @param {string} props.nombre - Nombre de la persona
 * @param {string} props.apellido - Apellido de la persona
 * @param {string} props.profesion - Cargo / profesión
 * @param {string} props.imagen - URL de la foto de perfil
 */
...
/**
 * Ejercicio 2: Tarjetas de presentación reutilizables.
 * Demuestra el uso de `Tarjeta` (subcomponente) con múltiples instancias con props distintas.
 */
